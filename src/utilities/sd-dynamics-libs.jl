...
function get_sub_Types_exclude_fieldnames()
    ...
    non_exclude_fieldnames_non_gens =
        (:Bus, :name, :P, :Q, :kPL, :kQL, :Y_n,
         :vmax, :vmin,
         :Pmax, :Pmin,
         :Qmax, :Qmin,
         :comp_type, :Bus_num, :Bus_type,
         :loc_P, :loc_Q )
    ...
    non_exclude_fieldnames_gens =
        (:Bus, :name, :P, :D, :H, :Ωb, :ωs,
         :ra, :xℓ, :X_d, :X_q,
         :X_d_dash, :X_q_dash,
         :X_d_2dash, :X_q_2dash,
         :T_d_dash, :T_q_dash,
         :T_d_2dash, :T_q_2dash,
         :αp, :αq, :Y_n, :Q, :Sn, :vh, :θh,
         :vmax, :vmin,
         :Pmax, :Pmin,
         :Qmax, :Qmin,
         :comp_type,
    ...
    non_exclude_fieldnames_plants_gens =
        (:Gen, :Gov, :Exc, :p_order,
         :v_ref, :ω_ref, :comp_type, :Bus,
         :name, :Bus_type, :Bus_num,
         :with_loc_load, :isa_slack,
         :isa_condenser )
