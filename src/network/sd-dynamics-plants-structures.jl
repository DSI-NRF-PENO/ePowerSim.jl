...
function hybrid_pf_plant_SM_idq!( dx, x, (p_agg, plant), t )
        
    cb_sw, src_i, dst_i, f_t, p, global_pf_param, node_pf_param =  p_agg

    p_gen,  plant_control_sig = p
    ...
    gen_fun!(dx, x,
             (cb_sw, u_gov_τm, u_avr_vf, src_i, dst_i, gen_f_t, p_gen, global_pf_param, node_pf_param ), t)
          
    return nothing
        
end

function node_pf_plant_SM_idq!( dx, x, (p_agg, plant), t )
    ...
    gen_fun!(dx, x,
             (cb_sw, u_gov_τm, u_avr_vf, src_i, dst_i, gen_f_t, p_gen, node_pf_param ), t)
...
function global_pf_plant_SM_idq!( dx, x, (p_agg, plant), t )
    ...
    gen_fun!(dx, x,
             (cb_sw, u_gov_τm, u_avr_vf, src_i, dst_i, gen_f_t, p_gen,  global_pf_param ), t)
...
function network_current_plant_SM_v6!( dx, x, (p_agg, plant), t )
    ...
    gen_fun!(dx, x,
             (cb_sw, u_gov_τm, u_avr_vf, src_i, dst_i, gen_f_t, p_gen), t)
...
function initial_pf_plant_SM_v6!( dx, x, (p_agg, plant), t )
...
@kwdef struct plant_SM_idq <: SdGenPlant
    Gen::SM_2axis_idq
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ω_ref::Float64 = 1.0

    comp_type::Symbol = :plant_SM_idq    
    ...
    algebraic_vars_syms::Vector{Symbol} = Symbol[ Gen.algebraic_vars_syms...]
    state_vars_syms::Vector{Symbol} = Symbol[ Gen.state_vars_syms...]
    syms::Vector{Symbol} = Symbol[ Gen.syms...; ]

    stab_state_vars_syms::Vector{Symbol} = Symbol[ Gen.stab_state_vars_syms... ]

    im_algebraic_vars_syms::Vector{Symbol} = Symbol[Gen.im_algebraic_vars_syms...; ]
    ...
    state_dim::Int64 = length(state_vars_syms) 
    dim::Int64       = length(syms)    
    dims::Vector{Int64} = Int64[ Gen.dim...; ]
    dae_var::Vector{Bool} = Bool[ Gen.dae_var...;]
    mass_matrix::Diagonal{Int64, Vector{Int64}} = Diagonal(Int.(dae_var))
    param::Vector{Vector{Symbol}} = Vector{Symbol}[ Gen.param, plant_control_sig_syms]
    param_values::Vector{Vector{Float64} } = Vector{Float64}[Gen.param_values, plant_control_sig]
    
    dict_param_syms_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate( [ param...; ]) )
    
    func::Vector{Function} = Function[ initial_pf_plant_SM_idq!, network_current_plant_SM_idq!, global_pf_plant_SM_idq!, node_pf_plant_SM_idq!, hybrid_pf_plant_SM_idq! ]    
    control_sig_syms::Vector{Symbol} = Symbol[ plant_control_sig_syms...; Gen.control_sig_syms...]
    control_sig::Vector{Float64} = [
        plant_control_sig...;ones(length(control_sig_syms) - length(plant_control_sig_syms))...]
    output_sig_syms::Vector{Symbol} = Symbol[ Gen.output_sig_syms...]
    output_sig::Vector{Float64} = ones(length(output_sig_syms))         
    cb_state_event_func::Vector{Function}      = Function[ Gen.cb_state_event_func...; ]  
    cb_state_affect_func::Vector{Function}     = Function[ Gen.cb_state_affect_func...;  ]    

    cb_state_syms::Vector{Symbol}              = Symbol[ Gen.cb_state_syms...; ]           
    cb_state_conditions::Vector{Float64}       = Float64[ Gen.cb_state_conditions...; ]     
    cb_state_values::Vector{Function}          = Function[ Gen.cb_state_values...;]
    cb_state_sym2Idx::Vector{Int64}            = Int64[dict_state_syms[ state_sym ] for state_sym in cb_state_syms ]
    ...
    cb_dyn_state_event_func::Vector{Function}  = Function[ Gen.cb_dyn_state_event_func...; ]
    cb_dyn_state_affect_func::Vector{Function} = Function[ Gen.cb_dyn_state_affect_func...; ]    
    cb_dyn_state_syms::Vector{Symbol}          = Symbol[ Gen.cb_dyn_state_syms...; ]
    
    cb_dict_dyn_state_syms2sw_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate(unique( cb_dyn_state_syms ) ))
    cb_dyn_state_sw_Idx::Vector{Int64 }         = Int64[Gen.cb_dyn_state_sw_Idx...; ]
            
    cb_dyn_state_conditions::Vector{Float64}   = Float64[ Gen.cb_dyn_state_conditions...;  ]  
    cb_dyn_state_values::Vector{Function}       = Function[ Gen.cb_dyn_state_values...;  ]
    cb_dyn_state_sym2Idx::Vector{Int64}        = Int64[dict_state_syms[state_sym] for state_sym in cb_dyn_state_syms]
    cb_dyn_param_state_sw::Vector{Int64}       = Int64[ Gen.cb_dyn_param_state_sw...;  ]
    ...
    # system_matrices = get_only_gen_plant_system_matrices( Gen; only_gen = true )
    ...
    # system_stab_matrices = get_only_gen_plant_system_stability_matrices( Gen; only_gen = true )
    
end


function hybrid_pf_plant_SM_v6!( dx, x, (p_agg, plant), t )
...
function node_pf_plant_SM_v6!( dx, x, (p_agg, plant), t )
...
function global_pf_plant_SM_v6!( dx, x, (p_agg, plant), t )
...
@kwdef struct plant_SM_v6 <: SdGenPlant
    Gen::Union{pf_SM_2axis_v6, SM_2axis_v6, SM_2axis_cb, SM_2axis_cb_direct} 
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ω_ref::Float64 = 1.0

    comp_type::Symbol = :plant_SM_v6    
    ...
    dict_param_syms_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate([ param...; ] ) )
    func::Vector{Function} = Function[ initial_pf_plant_SM_v6!, network_current_plant_SM_v6!, global_pf_plant_SM_v6!, node_pf_plant_SM_v6!, hybrid_pf_plant_SM_v6! ]
...
function hybrid_pf_plant_millano!( dx, x, (p_agg, plant), t )
...
function node_pf_plant_millano!( dx, x, (p_agg, plant), t )
...
function global_pf_plant_millano!( dx, x, (p_agg, plant), t )
...
function network_current_plant_millano_non_flattened!( dx, x, (p_agg, plant), t )
...
function initial_pf_plant_millano_non_flattened!( dx, x, (p_agg, plant), t )
    ...
    gen_fun!(du_gen, u_gen,
             (cb_sw_gen, u_gov_τm, u_avr_vf, src_i, dst_i, gen_ft, p_gen, pf_U, Inet ), t)
...
function plant_millano!( dx, x, (p_agg, plant), t )
...
@kwdef struct plant_millano_idq <: SdGenPlant
    Gen::SM_2axis_cb_idq
    ...
    comp_type::Symbol = :plant_millano_idq    
    ...
    func::Vector{Function} = Function[ initial_pf_plant_millano!, network_current_plant_millano!, global_pf_plant_millano!, node_pf_plant_millano!, hybrid_pf_plant_millano! ]
...
@kwdef struct plant_millano_v6 <: SdGenPlant
    Gen::SM_2axis_cb_v6
    Gov::gov_ieee_tgov1_cb
    Exc::avr_t1_cb
    p_order::Float64 = 1.0
    ...
    comp_type::Symbol = :plant_millano_v6        
...
@kwdef struct plant_millano <: SdGenPlant 
    Gen::Union{SM_2axis_cb_idq, SM_2axis_cb_v6}
    Gov::Union{gov_t0_cb, gov_t1_cb, gov_ieee_tgov1_cb}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer  }  
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ω_ref::Float64 = 1.0

    comp_type::Symbol = :plant_millano        
    ...
    #cb_dyn_param_state_sw::Vector{Vector{Int64}} = Vector{Int64}[ Gen.cb_dyn_param_state_sw, Gov.cb_dyn_param_state_sw, Exc.cb_dyn_param_state_sw ]
...
function initial_pf_plant_no_gov!( dx, x, (p_agg, plant), t )
...
@kwdef struct plant_no_gov_idq <: SdGenPlant
    # Gen::test_SM_2axis_Ctrld_cb
    Gen::SC_2axis_cb_idq
    Exc::avr_t1_cb
    v_ref::Float64 = 1.0
    ω_ref::Float64 = 1.0

    comp_type::Symbol = :plant_no_gov_idq            
...
function hybrid_pf_plant_no_gov_no_avr_wt_loc_load!( dx, x, (p_agg, plant), t )
    
    cb_sw, src_i, dst_i, f_t, p, global_pf_param, node_pf_param =  p_agg
  
    gen_ft, vf0, pm0, loc_load_f_t = f_t

    gen      = plant.Gen
    loc_load = plant.Loc_load

    type_of_gen = Symbol(typeof(gen))
    ...
    states_dims = [gen.dim, loc_load.dim]

    state_offset = create_offsets(states_dims)
    state_Idx  = create_idxs(state_offset, states_dims)

    u_gen       = @view x[state_Idx[1]]    
    u_loc_load  = @view x[state_Idx[2]]

    du_gen      = @view dx[state_Idx[1]] 
    du_loc_load = @view dx[state_Idx[2]]

    if gen.cb_dyn_state_dim == 0 && loc_load.cb_dyn_state_dim == 0
        cb_sw_gen       = Int64[]
        cb_sw_loc_load  = Int64[]
        
    elseif gen.cb_dyn_state_dim == 0 && loc_load.cb_dyn_state_dim != 0

        cb_sw_gen      = Int64[]
        
        cb_sw_loc_load  = cb_sw
    ...
    elseif gen.cb_dyn_state_dim != 0  && loc_load.cb_dyn_state_dim == 0 
        ...
        cb_sw_gen      = @view cb_sw[cb_sw_Idx[1]]
        cb_sw_loc_load = @view cb_sw[cb_sw_Idx[2]]        
    end
    
    p_gen, p_loc_load, plant_control_sig = p
    ...
    if type_of_gen == :SM_2axis_wt_loc_load_cb_idq || type_of_gen == :SM_2axis_wt_loc_load_cb_v6
        
        gen_fun!(du_gen, u_gen,
                 (cb_sw_gen, u_gov_τm, u_avr_vf,
...
function node_pf_plant_no_gov_no_avr_wt_loc_load!( dx, x, (p_agg, plant), t )
...
function global_pf_plant_no_gov_no_avr_wt_loc_load!( dx, x, (p_agg, plant), t )
...
function network_current_plant_no_gov_no_avr_wt_loc_load!( dx, x, (p_agg, plant), t )
...
function initial_pf_plant_no_gov_no_avr_wt_loc_load!( dx, x, (p_agg, plant), t )
...
@kwdef struct plant_no_gov_no_avr_wt_loc_load <: SdGenPlant
    Gen::Union{SM_2axis_wt_loc_load_cb_idq, SM_2axis_wt_loc_load_cb_v6 }
    Loc_load::loc_Load_t1
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ω_ref::Float64 = 1.0

    comp_type::Symbol = :plant_no_gov_no_avr_wt_loc_load
    ...
    algebraic_vars_syms::Vector{Symbol} = Symbol[ Gen.algebraic_vars_syms...; Loc_load.algebraic_vars_syms...]
    
    state_vars_syms::Vector{Symbol} = Symbol[ Gen.state_vars_syms...; Loc_load.state_vars_syms... ]
    
    syms::Vector{Symbol}  = Symbol[ Gen.syms...; Loc_load.syms... ]

    stab_state_vars_syms::Vector{Symbol} = Symbol[ Gen.stab_state_vars_syms... ; Loc_load.state_vars_syms... ]
    ...
    dims::Vector{Int64} = Int64[ Gen.dim, Loc_load.dim ]
    
    dae_var::Vector{Bool} = Bool[ Gen.dae_var...; Loc_load.dae_var... ]
    
    mass_matrix::Diagonal{Int64, Vector{Int64}} = Diagonal(Int.(dae_var))
    
    param::Vector{Vector{Symbol}} = Vector{Symbol}[ Gen.param, Loc_load.param, plant_control_sig_syms ]
    param_values::Vector{Vector{Float64} } = Vector{Float64}[Gen.param_values, Loc_load.param_values, plant_control_sig]

    loc_load_param_idx::Int64 = 2

    
    
    dict_param_syms_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate( [param...;] ) )
    func::Vector{Function} = Function[ initial_pf_plant_no_gov_no_avr_wt_loc_load!, network_current_plant_no_gov_no_avr_wt_loc_load!, global_pf_plant_no_gov_no_avr_wt_loc_load!, node_pf_plant_no_gov_no_avr_wt_loc_load!, hybrid_pf_plant_no_gov_no_avr_wt_loc_load!  ]

    control_sig_syms::Vector{Symbol} = Symbol[ plant_control_sig_syms...; Gen.control_sig_syms...; Loc_load.control_sig_syms... ]
    
    control_sig::Vector{Float64} = [ plant_control_sig...; ones(length(control_sig_syms) - length(plant_control_sig_syms))...]
    
    output_sig_syms::Vector{Symbol} = Symbol[ Gen.output_sig_syms...; Loc_load.output_sig_syms... ]
    
    output_sig::Vector{Float64} = ones(length(output_sig_syms))         
    cb_state_event_func::Vector{Function} = Function[ Gen.cb_state_event_func...; Loc_load.cb_state_event_func... ]
    
    cb_state_affect_func::Vector{Function} = Function[ Gen.cb_state_affect_func...; Loc_load.cb_state_affect_func... ]
    
    #
    cb_state_syms::Vector{ Union{Symbol, Tuple{Symbol,Symbol}} } = Union{Symbol, Tuple{Symbol,Symbol}}[ Gen.cb_state_syms...; Loc_load.cb_state_syms... ]
    #
    
    cb_state_conditions::Vector{Float64} = Float64[ Gen.cb_state_conditions...; Loc_load.cb_state_conditions... ]
    
    cb_state_values::Vector{Function} = Function[ Gen.cb_state_values...; Loc_load.cb_state_values... ]
    ...
    cb_dyn_state_event_func::Vector{Function}  = Function[ Gen.cb_dyn_state_event_func...; Loc_load.cb_dyn_state_event_func... ]
    cb_dyn_state_affect_func::Vector{Function} = Function[ Gen.cb_dyn_state_affect_func...; Loc_load.cb_dyn_state_affect_func... ]

    #
    cb_dyn_state_syms::Vector{ Union{Symbol, Tuple{Symbol,Symbol}} }  = Union{Symbol, Tuple{Symbol,Symbol}}[ Gen.cb_dyn_state_syms...; Loc_load.cb_dyn_state_syms... ]
    #
    ...
    cb_dyn_state_conditions::Vector{Float64}   = Float64[ Gen.cb_dyn_state_conditions...;  Loc_load.cb_dyn_state_conditions... ]
    
    cb_dyn_state_values::Vector{Function} = Function[ Gen.cb_dyn_state_values...; Loc_load.cb_dyn_state_values... ]

    #
    cb_dyn_state_sym2Idx::Vector{ Union{Int64, Tuple{Int64, Int64}} } = Union{Int64, Tuple{Int64, Int64}}[Symbol(typeof(state_sym)) == :Symbol ?  dict_state_syms[state_sym] : ( dict_state_syms[state_sym[1]], dict_state_syms[state_sym[1]])  for state_sym in  cb_dyn_state_syms ]
    #
    
    cb_dyn_param_state_sw::Vector{Int64} = Int64[ Gen.cb_dyn_param_state_sw...; Loc_load.cb_dyn_param_state_sw... ]
...
@kwdef struct plant_no_gov_wt_loc_load_idq <: SdGenPlant
    Gen::SC_2axis_wt_loc_load_cb_idq
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer }
    Loc_load::loc_Load_t1
    v_ref::Float64 = 1.0
    ω_ref::Float64 = 1.0

    comp_type::Symbol = :plant_no_gov_wt_loc_load_idq
...
@kwdef struct plant_no_gov_wt_loc_load <: SdGenPlant
    Gen::Union{SC_2axis_wt_loc_load_cb_idq, SC_2axis_wt_loc_load_cb_v6}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}
    Loc_load::loc_Load_t1
    v_ref::Float64 = 1.0
    ω_ref::Float64 = 1.0

    comp_type::Symbol = :plant_no_gov_wt_loc_load    
...
@kwdef struct plant_wt_loc_load_idq <: SdGenPlant
    Gen::SM_2axis_wt_loc_load_cb_idq
    ...
    comp_type::Symbol = :plant_wt_loc_load_idq        
...
@kwdef struct plant_wt_loc_load <: SdGenPlant
    Gen::Union{SM_2axis_wt_loc_load_cb_idq, SM_2axis_wt_loc_load_cb_v6}
    Gov::Union{gov_ieee_tgov1_cb, gov_t0_cb, gov_t1_cb, gov_t1_cb_sauer}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}
    Loc_load::loc_Load_t1
    ...
    comp_type::Symbol = :plant_wt_loc_load               
...
function hybrid_pf_plant_rscad!( dx, x, (p_agg, plant), t )
...
function node_pf_plant_rscad!( dx, x, (p_agg, plant), t )
...
function global_pf_plant_rscad!( dx, x, (p_agg, plant), t )
...
function network_current_plant_rscad!( dx, x, (p_agg, plant), t )
...
function initial_pf_plant_rscad!( dx, x, (p_agg, plant), t )
...
function plant_rscad_flattened!( dx, x, (p_agg, plant), t )
...
@kwdef struct plant_rscad_idq <: SdGenPlant
    Gen::SM_2axis_cb_idq
    # Gov::gov_ieee_tgov1_cb   
    # Exc::avr_t1_cb
    Gov::Union{gov_ieee_tgov1_cb, gov_t0_cb, gov_t1_cb, gov_t1_cb_sauer }
    ...
    comp_type::Symbol = :plant_rscad_idq                    
    ...
    dict_param_syms_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate( [param...;] ) )
    func::Vector{Function} = Function[ initial_pf_plant_rscad!, network_current_plant_rscad!, global_pf_plant_rscad!, node_pf_plant_rscad!, hybrid_pf_plant_rscad! ]
...
@kwdef struct plant_rscad_v6 <: SdGenPlant
    Gen::SM_2axis_cb_v6
    # Gov::gov_ieee_tgov1_cb
    # Exc::avr_t1_cb
    Gov::Union{gov_ieee_tgov1_cb, gov_t0_cb, gov_t1_cb, gov_t1_cb_sauer}
    ...
    comp_type::Symbol = :plant_rscad_v6    
...
@kwdef struct plant_rscad <: SdGenPlant
    # Gen::test_SM_2axis_Ctrld_cb
    Gen::Union{SM_2axis_cb_idq, SM_2axis_cb_v6}
    Gov::Union{gov_ieee_tgov1_cb, gov_t0_cb, gov_t1_cb, gov_t1_cb_sauer}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}    
    ...
    param::Vector{Vector{Symbol}} = Vector{Symbol}[ Gen.param, Gov.param,  Exc.param, plant_control_sig_syms]
    param_values::Vector{Vector{Float64} } = Vector{Float64}[Gen.param_values, Gov.param_values, Exc.param_values, plant_control_sig]    
    # param::Vector{Symbol} = Symbol[ Gen.param...; Gov.param...;  Exc.param...; plant_control_sig_syms...]
    # param_values::Vector{Union{ComplexF64,Float64}} = Union{ComplexF64,Float64}[
    #     get_component_params_value(Gen)...;get_component_params_value(Gov)...;get_component_params_value(Exc)...;plant_control_sig...]
...
function network_current_plant_cb!( dx, x, (p_agg, plant), t )
...
@kwdef struct plant_cb_idq <: SdGenPlant
    Gen::SM_2axis_cb_idq
    Gov::Union{gov_ieee_tgov1_cb, gov_t0_cb, gov_t1_cb, gov_t1_cb_sauer}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}
    p_order::Float64 = 1.0
...
@kwdef struct plant_cb_direct <: SdGenPlant
    # Gen::test_SM_2axis_Ctrld_cb
    Gen::SM_2axis_cb_direct
    Gov::Union{gov_ieee_tgov1_cb, gov_t0_cb, gov_t1_cb, gov_t1_cb_sauer}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ...
    comp_type::Symbol = :plant_cb_direct                   
    ...
    cb_state_event_func::Vector{Function}      = Function[ Gen.cb_state_event_func...; Gov.cb_state_event_func...; Exc.cb_state_event_func... ]  
    cb_state_affect_func::Vector{Function}     = Function[ Gen.cb_state_affect_func...; Gov.cb_state_affect_func...; Exc.cb_state_affect_func... ]    
    cb_state_syms::Vector{Symbol}              = Symbol[ Gen.cb_state_syms...; Gov.cb_state_syms...; Exc.cb_state_syms... ]           
    cb_state_conditions::Vector{Float64}       = Float64[ Gen.cb_state_conditions...; Gov.cb_state_conditions...;  Exc.cb_state_conditions... ]     
    cb_state_values::Vector{Function}           = Function[ Gen.cb_state_values...; Gov.cb_state_values...; Exc.cb_state_values... ]
    cb_state_sym2Idx::Vector{Int64}            = Int64[dict_state_syms[ state_sym ] for state_sym in cb_state_syms ]
    ...
    cb_dyn_state_event_func::Vector{Function}  = Function[ Gen.cb_dyn_state_event_func...; Gov.cb_dyn_state_event_func...; Exc.cb_dyn_state_event_func... ]
    cb_dyn_state_affect_func::Vector{Function} = Function[ Gen.cb_dyn_state_affect_func...; Gov.cb_dyn_state_affect_func...; Exc.cb_dyn_state_affect_func... ]    
    cb_dyn_state_syms::Vector{Symbol}          = Symbol[ Gen.cb_dyn_state_syms...; Gov.cb_dyn_state_syms...; Exc.cb_dyn_state_syms... ]
    
    cb_dict_dyn_state_syms2sw_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate(unique( cb_dyn_state_syms ) ))
    cb_dyn_state_sw_Idx::Vector{Int64 }         = Int64[Gen.cb_dyn_state_sw_Idx...; Gov.cb_dyn_state_sw_Idx...; Exc.cb_dyn_state_sw_Idx... ]
...
@kwdef struct plant_cb_millano  <: SdGenPlant
    Gen::SM_2axis_cb_millano 
    # Gov::gov_t1_cb_sauer 
    # Exc::avr_t1_cb_sauer
    Gov::Union{gov_ieee_tgov1_cb, gov_t0_cb, gov_t1_cb, gov_t1_cb_sauer}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}   
    ...
    comp_type::Symbol = :plant_cb_millano    
...
@kwdef struct plant_cb <: SdGenPlant
    Gen::Union{SM_2axis_cb, SM_2axis_cb_idq, SM_2axis_cb_v6}  
    Gov::Union{gov_t0_cb, gov_t1_cb, gov_ieee_tgov1_cb, gov_t1_cb_sauer} 
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}   
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ω_ref::Float64 = 1.0

    comp_type::Symbol = :plant_cb       
...
@kwdef struct plant_cb_inf_bus 
    Gen::SM_2axis_cb_inf_bus 
    Gov::Union{gov_ieee_tgov1_cb, gov_t0_cb, gov_t1_cb, gov_t1_cb_sauer}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}  
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ...
    comp_type::Symbol = :plant_cb_inf_bus                
    ...
    # im_algebraic_vars_syms::Vector{Symbol} = Symbol[ Gov.state_vars_syms...; Exc.state_vars_syms... ]
...
function plant_pss_cb!(dx, x, (p_agg, plant_pss), t )
    
    cb_sw, src_i, dst_i, f_t, p =  p_agg

    gen_ft, gov_f_t, avr_f_t, pss_f_t = f_t
    ...
    gov_states_syms = gov.syms
    avr_states_syms = avr.syms
    pss_states_syms = pss.syms

    dict_gen_syms = gen.dict_state_syms
    dict_gov_syms = gov.dict_state_syms
    dict_avr_syms = avr.dict_state_syms
    dict_pss_syms = pss.dict_state_syms

    gen_output_sigs = gen.output_sig_syms
    gov_output_sigs = gov.output_sig_syms
    avr_output_sigs = avr.output_sig_syms
    pss_output_sigs = pss.output_sig_syms    
    ...
    dim_gen_states = gen.dim
    dim_gov_states = gov.dim
    dim_avr_states = avr.dim
    dim_pss_states = pss.dim

    # states_dims    = plant_pss.dims
    
    states_dims   = [dim_gen_states,
                     dim_gov_states,
                     dim_avr_states,
                     dim_pss_states]
    ...
    u_gov  = @view x[state_Idx[2]]    
    u_avr  = @view x[state_Idx[3]]
    u_pss  = @view x[state_Idx[4]]
    
    du_gen = @view dx[state_Idx[1]] 
    du_gov = @view dx[state_Idx[2]]
    du_avr = @view dx[state_Idx[3]]
    du_pss = @view dx[state_Idx[4]]    

    dim_gen_cb_sw = gen.cb_dyn_state_dim
    dim_gov_cb_sw = gov.cb_dyn_state_dim
    dim_avr_cb_sw = avr.cb_dyn_state_dim
    dim_pss_cb_sw = pss.cb_dyn_state_dim

    dims_cb_sw = [dim_gen_cb_sw, dim_gov_cb_sw, dim_avr_cb_sw, dim_pss_cb_sw]
    ...
    cb_sw_gov = @view cb_sw[cb_sw_Idx[2]]
    cb_sw_avr = @view cb_sw[cb_sw_Idx[3]]
    cb_sw_pss = @view cb_sw[cb_sw_Idx[4]] 

    dim_gen_para = length(gen.param)
    dim_gov_para = length(gov.param)
    dim_avr_para = length(avr.param)
    dim_pss_para = length(pss.param)
    
    dim_params = [dim_gen_para,
                  dim_gov_para,
                  dim_avr_para,
                  dim_pss_para]
    
    params_offset = create_offsets(dim_params)
    
    params_Idx = create_idxs(params_offset, dim_params)
        
    p_gen = @view p[params_Idx[1]]
    p_gov = @view p[params_Idx[2]]
    p_avr = @view p[params_Idx[3]]
    p_pss = @view p[params_Idx[4]] 
    ...
    u_pss_vs = u_pss[ dict_pss_syms[ pss_output_sigs[1] ] ]  
    ...
    avr_fun!(du_avr, u_avr,
             (cb_sw_avr, u_pss_vs, u_gen_ur_ui, avr_f_t, p_avr), t)

    pss_fun!(du_pss, u_pss,
             (cb_sw_pss, u_gen_ω, pss_f_t, p_pss), t)    
...
@kwdef struct plant_pss_cb_idq <: SdGenPlant
    Gen::SM_2axis_cb_idq
    Gov::gov_t1_cb
    Exc::avr_t1_with_pss_cb
    Pss::pss_t2_cb
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ω_ref::Float64 = 1.0

    comp_type::Symbol = :plant_pss_cb_idq                    
    ...
    plant_control_sig_syms::Vector{Symbol} = Symbol[:p_order, :v_ref, :ω_ref]
    plant_control_sig::Vector{Float64} = Float64[ p_order, v_ref, ω_ref]
    algebraic_vars_syms::Vector{Symbol} = Symbol[ Gen.algebraic_vars_syms...; Gov.algebraic_vars_syms...; Exc.algebraic_vars_syms...; Pss.algebraic_vars_syms... ]
    state_vars_syms::Vector{Symbol} = Symbol[ Gen.state_vars_syms...; Gov.state_vars_syms...; Exc.state_vars_syms...; Pss.state_vars_syms... ]
    # syms::Vector{Symbol}  = Symbol[ state_vars_syms...; algebraic_vars_syms...]
    syms::Vector{Symbol}  = Symbol[ Gen.syms...; Gov.syms...; Exc.syms...; Pss.syms... ]
    
    stab_state_vars_syms::Vector{Symbol} = Symbol[ Gen.stab_state_vars_syms...; Gov.state_vars_syms...; Exc.state_vars_syms...; Pss.state_vars_syms... ]
        
    im_algebraic_vars_syms::Vector{Symbol} = Symbol[Gen.im_algebraic_vars_syms...; Gov.im_algebraic_vars_syms...; Exc.im_algebraic_vars_syms...; Pss.im_algebraic_vars_syms... ]

    # im_algebraic_vars_syms::Vector{Symbol} = Symbol[ Gov.syms...; Exc.syms...; Pss.syms... ]
    ...
    state_dim::Int64 = length(state_vars_syms) 
    dim::Int64       = length(syms)    
    dims::Vector{Int64} = Int64[ Gen.dim...; Gov.dim...; Exc.dim...; Pss.dim...]
    dae_var::Vector{Bool} = Bool[ Gen.dae_var...; Gov.dae_var...; Exc.dae_var...; Pss.dae_var...]
    mass_matrix::Diagonal{Int64, Vector{Int64}} = Diagonal(Int.(dae_var))
    # mass_matrix::Diagonal{Int64, Vector{Int64}} = DAE_MassMatrix(length(state_vars_syms), length(algebraic_vars_syms))
    # dae_var::Vector{Bool} = DAE_BoolVector( length(state_vars_syms), length(algebraic_vars_syms) )    
    param::Vector{Symbol} = Symbol[ Gen.param...; Gov.param...;  Exc.param...; Pss.param...; plant_control_sig_syms...]
    param_values::Vector{Union{ComplexF64,Float64}} = Union{ComplexF64,Float64}[
        get_component_params_value(Gen)...;get_component_params_value(Gov)...;get_component_params_value(Exc)...; get_component_params_value(Pss)...; plant_control_sig...]

    
    
    dict_param_syms_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate( [param...;] ) )    
    func::Vector{Function} = Function[ plant_pss_cb!  ]    
    control_sig_syms::Vector{Symbol} = Symbol[ plant_control_sig_syms...; Gen.control_sig_syms...; Gov.control_sig_syms...; Exc.control_sig_syms...; Pss.control_sig_syms...]
    control_sig::Vector{Float64} = [ plant_control_sig...;ones(length(control_sig_syms) - length(plant_control_sig_syms))...]
    output_sig_syms::Vector{Symbol} = Symbol[ Gen.output_sig_syms...; Gov.output_sig_syms...; Exc.output_sig_syms...;  Pss.output_sig_syms...]
    output_sig::Vector{Float64} = ones(length(output_sig_syms))    
    cb_state_event_func::Vector{Function} = Function[ Gen.cb_state_event_func...; Gov.cb_state_event_func...; Exc.cb_state_event_func...; Pss.cb_state_event_func... ]  
    cb_state_affect_func::Vector{Function} = Function[ Gen.cb_state_affect_func...; Gov.cb_state_affect_func...; Exc.cb_state_affect_func...;  Pss.cb_state_affect_func... ]    
    cb_state_syms::Vector{Symbol} = Symbol[ Gen.cb_state_syms...; Gov.cb_state_syms...; Exc.cb_state_syms...;  Pss.cb_state_syms... ]           
    cb_state_conditions::Vector{Float64} = Float64[ Gen.cb_state_conditions...; Gov.cb_state_conditions...;  Exc.cb_state_conditions...; Pss.cb_state_conditions... ]     
    cb_state_values::Vector{Function} = Function[ Gen.cb_state_values...; Gov.cb_state_values...; Exc.cb_state_values...; Pss.cb_state_values... ]
    cb_state_sym2Idx::Vector{Int64} = Int64[dict_state_syms[ state_sym ] for state_sym in cb_state_syms ]
    ...
    cb_dyn_state_event_func::Vector{Function}  = Function[ Gen.cb_dyn_state_event_func...; Gov.cb_dyn_state_event_func...; Exc.cb_dyn_state_event_func...; Pss.cb_dyn_state_event_func... ]
    cb_dyn_state_affect_func::Vector{Function} = Function[ Gen.cb_dyn_state_affect_func...; Gov.cb_dyn_state_affect_func...; Exc.cb_dyn_state_affect_func...; Pss.cb_dyn_state_affect_func... ]    
    cb_dyn_state_syms::Vector{Symbol} = Symbol[ Gen.cb_dyn_state_syms...; Gov.cb_dyn_state_syms...; Exc.cb_dyn_state_syms...; Pss.cb_dyn_state_syms... ]
    
    cb_dict_dyn_state_syms2sw_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate(unique( cb_dyn_state_syms ) ))
    cb_dyn_state_sw_Idx::Vector{Int64 } = Int64[Gen.cb_dyn_state_sw_Idx...; Gov.cb_dyn_state_sw_Idx...; Exc.cb_dyn_state_sw_Idx...; Pss.cb_dyn_state_sw_Idx...; ]
    
    cb_dyn_state_conditions::Vector{Float64} = Float64[ Gen.cb_dyn_state_conditions...; Gov.cb_dyn_state_conditions...; Exc.cb_dyn_state_conditions...; Pss.cb_dyn_state_conditions... ]  
    cb_dyn_state_values::Vector{Function} = Function[ Gen.cb_dyn_state_values...; Gov.cb_dyn_state_values...; Exc.cb_dyn_state_values...;  Pss.cb_dyn_state_values... ]
    cb_dyn_state_sym2Idx::Vector{Int64} = Int64[dict_state_syms[state_sym] for state_sym in cb_dyn_state_syms ]
    cb_dyn_param_state_sw::Vector{Int64} = Int64[ Gen.cb_dyn_param_state_sw...; Gov.cb_dyn_param_state_sw...; Exc.cb_dyn_param_state_sw...; Pss.cb_dyn_param_state_sw... ]
    cb_dyn_state_dim::Int64 = length(cb_dyn_state_conditions)
    
end


@kwdef struct plant_pss_cb_v6 <: SdGenPlant
    Gen::SM_2axis_cb_v6
    Gov::gov_t1_cb
    Exc::avr_t1_with_pss_cb
    Pss::pss_t2_cb
    ...
    comp_type::Symbol = :plant_pss_cb_v6    
    ...
    # im_algebraic_vars_syms::Vector{Symbol} = Symbol[ Gov.algebraic_vars_syms...; Exc.algebraic_vars_syms...; Pss.algebraic_vars_syms... ]
...
@kwdef struct plant_pss_cb_direct <: SdGenPlant
    Gen::SM_2axis_cb_direct
    Gov::gov_t1_cb
    Exc::avr_t1_with_pss_cb
    Pss::pss_t2_cb
    ...
    comp_type::Symbol = :plant_pss_cb_direct        
...
@kwdef struct plant_pss_cb_sauer <: SdGenPlant
    Gen::SM_2axis_cb_millano
    Gov::gov_t1_cb
    Exc::avr_t1_with_pss_cb
    Pss::pss_t2_cb
    ...
    comp_type::Symbol = :plant_pss_cb_sauer            
...
@kwdef struct plant_pss_cb <: SdGenPlant
    Gen::SM_2axis_cb
    Gov::gov_t1_cb
    Exc::avr_t1_with_pss_cb
    Pss::pss_t2_cb
...
@kwdef struct plant_pss_cb_inf 
    ...
    comp_type::Symbol = :plant_pss_cb_inf                    
...
@kwdef struct plant_pss_cb_inf_bus 
    Gen::SM_2axis_cb_inf_bus
    Gov::gov_t1_cb
    Exc::avr_t1_with_pss_cb
    Pss::pss_t2_cb
    ...
    comp_type::Symbol = :plant_pss_cb_inf_bus    
...
function plant_Infinite_bus!(dx, x, (p_agg, plant ), t)
    ...
    gen_fun!(du_gen, u_gen,
             (cb_sw_gen, src_i, dst_i, f_t, p_gen), t)
...
@kwdef struct plant_Infinite_cb_bus 
    # Gen::test_SM_2axis_Ctrld_cb
    Gen::Infinite_bus
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ...
    comp_type::Symbol = :plant_Infinite_cb_bus         
    ...
    mass_matrix::Diagonal{Int64, Vector{Int64}} = Diagonal(Int.(dae_var))
    # mass_matrix::Diagonal{Int64, Vector{Int64}} = DAE_MassMatrix(length(state_vars_syms), length(algebraic_vars_syms))    
    param::Vector{Symbol} = Symbol[ Gen.param...; ]
    param_values::Vector{Union{ComplexF64,Float64}} = Union{ComplexF64,Float64}[ get_component_params_value(Gen)...; ]

    
    
    dict_param_syms_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate( [param...;] ) )    
    func::Vector{Function} = Function[plant_Infinite_bus!]    
    control_sig_syms::Vector{Symbol} = Symbol[ plant_control_sig_syms...; Gen.control_sig_syms...; ]
    control_sig::Vector{Float64} = [ plant_control_sig...; ones(length(control_sig_syms) - length(plant_control_sig_syms))...]
    output_sig_syms::Vector{Symbol} = Symbol[ Gen.output_sig_syms...; ]
    output_sig::Vector{Float64} = ones(length(output_sig_syms))     
...
@kwdef struct plant_Infinite_bus 
    # Gen::test_SM_2axis_Ctrld_cb
    Gen::Infinite_bus
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ...
    comp_type::Symbol = :plant_Infinite_bus             
...
function hybrid_pf_plant_SM!( dx, x, (p_agg, plant), t )
...
function node_pf_plant_SM!( dx, x, (p_agg, plant), t )
...
function global_pf_plant_SM!( dx, x, (p_agg, plant), t )
...
function network_current_plant_SM!( dx, x, (p_agg, plant), t )
...
function initial_pf_plant_SM!( dx, x, (p_agg, plant), t )
...
#--------------------------------------------------------
# plants with system_matrix
#--------------------------------------------------------


@kwdef struct plant_SM_system_matrix <: SdGenPlant
    Gen::Union{SM_2axis_idq, SM_2axis_v6} 
    p_order::Float64 = 1.0
    v_ref::Float64 = 1.0
    ω_ref::Float64 = 1.0

    comp_type::Symbol = :plant_SM_system_matrix             
    ...
    dict_param_syms_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate( [param...;] ) )  
    func::Vector{Function} = Function[ initial_pf_plant_SM!, network_current_plant_SM!, global_pf_plant_SM!, node_pf_plant_SM!, hybrid_pf_plant_SM! ]
...
@kwdef struct plant_no_gov_system_matrix <: SdGenPlant
    ...
    comp_type::Symbol = :plant_no_gov_system_matrix    
...
@kwdef struct plant_SM_2axis_cb_system_matrix <: SdGenPlant
    Gen::Union{SM_2axis_cb_idq, SM_2axis_cb_v6}
    Gov::Union{gov_t0_cb, gov_t1_cb, gov_ieee_tgov1_cb, gov_t1_cb_sauer}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}    
    p_order::Float64 = 1.0
    ...
    comp_type::Symbol = :plant_SM_2axis_cb_system_matrix    
...
function plant_conditional_non_flattened!( dx, x, (p_agg, plant), t )
    
    cb_sw, src_i, dst_i, f_t, p =  p_agg

    with_gov = plant.with_gov
    ...
    if with_gov == true
        ...
        # dim_gov_cb_sw = gov.cb_dyn_state_dim
        # dim_avr_cb_sw = avr.cb_dyn_state_dim
        # dim_loc_load_cb_sw = loc_load.cb_dyn_state_dim

        # dims_cb_sw = [dim_gen_cb_sw, dim_gov_cb_sw,
        #               dim_avr_cb_sw, dim_loc_load_cb_sw]
...
@kwdef struct plant_conditional_idq 
    Gen::SM_2axis_wt_loc_load_cb_idq
    Gov::Union{gov_ieee_tgov1_cb, gov_t0_cb, gov_t1_cb, gov_t1_cb_sauer}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}
    Loc_load::loc_Load_t1
    ...
    comp_type::Symbol = :plant_conditional_idq    
    ...
    dict_param_syms_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate( [param...;] ) )
    func::Vector{Function} = Function[ plant_conditional_non_flattened!, plant_conditional_non_flattened! ]
    ...
    cb_state_syms::Vector{Symbol} = Symbol[ Gen.cb_state_syms...; Gov.cb_state_syms...; Exc.cb_state_syms...; Loc_load.cb_state_syms... ]
    ...
    cb_dyn_state_event_func::Vector{Function}  = Function[ Gen.cb_dyn_state_event_func...; Gov.cb_dyn_state_event_func...; Exc.cb_dyn_state_event_func...; Loc_load.cb_dyn_state_event_func... ]
    cb_dyn_state_affect_func::Vector{Function} = Function[ Gen.cb_dyn_state_affect_func...; Gov.cb_dyn_state_affect_func...; Exc.cb_dyn_state_affect_func...; Loc_load.cb_dyn_state_affect_func... ]    
    cb_dyn_state_syms::Vector{Symbol}  = Symbol[ Gen.cb_dyn_state_syms...; Gov.cb_dyn_state_syms...; Exc.cb_dyn_state_syms...; Loc_load.cb_dyn_state_syms... ]
    
    cb_dict_dyn_state_syms2sw_Idx::OrderedDict{Symbol, Int64} = OrderedDict(sym => ind for (ind, sym) in enumerate(unique( cb_dyn_state_syms ) ))

    cb_dyn_state_sw_Idx::Vector{Int64 }  = Int64[Gen.cb_dyn_state_sw_Idx...; Gov.cb_dyn_state_sw_Idx...; Exc.cb_dyn_state_sw_Idx...; Loc_load.cb_dyn_state_sw_Idx... ]
...
@kwdef struct plant_conditional_v6 
    # Gen::test_SM_2axis_Ctrld_cb
    Gen::SM_2axis_wt_loc_load_cb_v6
    Gov::Union{gov_ieee_tgov1_cb, gov_t0_cb, gov_t1_cb, gov_t1_cb_sauer}
    Exc::Union{avr_t0_cb, avr_t1_cb, avr_t1_cb_sauer}
    ...
    comp_type::Symbol = :plant_conditional_v6       
...
function new_pf_plant_SM_v6!( dx, x, (p_agg, plant), t )
    ...
    gen_fun!(dx, x,
             (cb_sw, u_gov_τm, u_avr_vf, src_i, dst_i, gen_f_t, p_gen, pf_U, Inet), t)
...
function pf_plant_SM_v6!( dx, x, (p_agg, plant), t )
...
@kwdef struct pf_plant_SM_v6
    Gen::Union{pf_SM_2axis_v6}
    p_order::Float64 = 1.0
    v_ref::Float64   = 1.0
    ω_ref::Float64   = 1.0

    comp_type::Symbol = :pf_plant_SM_v6           
    ...
    func::Vector{Function} = Function[pf_plant_SM_v6!, pf_plant_SM_v6!, new_pf_plant_SM_v6!]    
    control_sig_syms::Vector{Symbol} = Symbol[ plant_control_sig_syms...; Gen.control_sig_syms...]
    control_sig::Vector{Float64} = [
        plant_control_sig...;ones(length(control_sig_syms) - length(plant_control_sig_syms))...]
    output_sig_syms::Vector{Symbol} = Symbol[ Gen.output_sig_syms...]
