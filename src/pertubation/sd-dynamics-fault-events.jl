...
#     dict_pre_or_post_fault_parameters =
#         Dict{Symbol, NamedTuple }()
    
#     for a_system_status in list_network_status
#         dict_pre_or_post_fault_parameters[a_system_status] =
#             get_system_pre_or_post_fault_parameters(
#                 system_status,
#                 Ynet_wt_nodes_idx_wt_adjacent_nodes,
#                 cleared_selected_lines_faults_net_para;
#                 pf_sta_ΔPQ_mismatch_parameters,    
...
#     cb_faults_no_resize = CallbackSet(
#         cb_on_fault_no_resize,
#         cb_clear_fault_no_resize)
...
#-----------------------------------------------------
# powerflow by power mismatch with faults
#-----------------------------------------------------
