#=
# [Example of Load-Generation Perturbations with IEEE 5 Bus Test System](@id ieee-5-bus-load-generation-perturbations)
=#
...
# sim_type  = "sim-sudden-change-load"
...
plot_sudden_target_parameter_plot =
    getproperty(
        sim_results_sudden_load_change,
        :target_parameter_plot)
